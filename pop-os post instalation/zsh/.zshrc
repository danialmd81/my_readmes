  ...
  # [Custum] Source the script before compinit to ensure completion works correctly
  ...
  # [Custum] Load your custom plugins
  ...
  # [Custum] User configuration - PATH settings
  ...
  # [Custum] Initialize rbenv
  eval "$(rbenv init -)"

  # [Custum] Auth tokens and environment variables
  export LOCALSTACK_AUTH_TOKEN="ls-coRowIlu-GIFi-1843-VArA-DESOYoToc20b"

  # [Custum] NVM configuration
